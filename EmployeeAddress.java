...
public class EmployeeAddress implements Serializable {
    ...
    public EmployeeAddress(Employee employee, String addressLine1, String addressLine2, String addressLine3, String cityTown, String country) {
    ...
    public String toString() {
        return "EmployeeAddress{" + "empId=" + empId + ", employee=" + employee + ", addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2 + ", addressLine3=" + addressLine3 + ", cityTown=" + cityTown + ", country=" + country + '}';
    }

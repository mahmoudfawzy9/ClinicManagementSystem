...
public class PdfService {
    ...
    public ByteArrayInputStream generatePdf(final PatientCase patientCase) {
        ...
        document.addAuthor("Mahmoud");
        document.addCreator("Mahmoud");
    ...
    public ByteArrayInputStream generatePdf(final com.mahmoud.clinicmanagementsystem.model.Document fileDocument) {
